                ...
                <div className="flex flex-col gap-20 lg:gap-40">
                    <div className="flex flex-col lg:flex-row gap-6 lg:justify-between lg:items-center">
                        ...
                        <div className="basis-2/4 flex flex-col gap-6">
                            ...
                            <p className="text-sm lg:text-base w-full xl:w-4/5">At Gulf Youth Bicycle, cycling isn&apos;s t just a business—it&apos;s s a way of life. Our journey began with a shared love for bikes and the freedom they bring. Over the years, we&apos;s ve grown from a small local shop into a trusted name in the cycling community, driven by our commitment to quality and our deep understanding of what cyclists need. Whether you&apos;s re a seasoned pro or just starting out, we believe every rider deserves the best, and we&apos;s re here to provide that.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-6 lg:justify-between lg:items-center">
                        ...
                        <div className="basis-2/4 flex flex-col gap-6">
                            ...
                            <p className="text-sm lg:text-base w-full xl:w-3/5">Beyond selling bikes, our mission is to foster a vibrant community of cyclists. We organize regular events, group rides, and workshops to bring enthusiasts together and promote a healthy, active lifestyle. Whether you&apos;s re looking to improve your skills, discover new trails, or simply connect with fellow riders, Gulf Youth Bicycle is your hub for all things cycling. Join us as we pedal towards a future where everyone can experience the joy and freedom of cycling.
